...
function ViewToDo({tasks, onTaskAdded}) {
    ...
    return (
        <>
            {tasks.length === 0 ? (
                <div
                    className="relative flex flex-col gap-5 items-center justify-center w-11/12 md:w-4/5 lg:w-full h-[90vh] bg-white dark:bg-gray-900 rounded-2xl overflow-y-auto p-4 shadow-lg">
                    <p className="dark:text-white text-black text-sm">No Task Created.</p>
                </div>
            ): (
                <div
